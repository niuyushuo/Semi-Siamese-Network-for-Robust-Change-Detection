...
class DataConfig:
    ...
    def get_data_config(self, data_name):
        ...
        if data_name == 'LEVIR':
            ...
            self.root_dir = '/home/yun13001/code/Change_detection/BIT/LEVIR-CD-256/'
        elif data_name == 'DSIFN':
            self.label_transform = "norm"
            self.root_dir = '/media/lidan/ssd2/CDData/DSIFN_256/'
        elif data_name == 'WHU':
            self.label_transform = "norm"
            self.root_dir = '/home/yun13001/code/change_detection/whu_dataset/Unet_train/whu_dataset/'
        elif data_name == 'CDD':
            self.label_transform = "norm"
