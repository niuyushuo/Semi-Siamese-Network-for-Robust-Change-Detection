...
class Siamese(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=1, init_features=32):
        ...
        self.checkpoint = torch.load('/home/yun13001/code/change_detection/whu_dataset/Unet_train/save_model/best_model_whu.pth', map_location=torch.device(self.device),weights_only=True)   ### bce model
